        ...
        configGroups: [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        value: "goal, constraints, context"
                    }
                ]
            },
            {
                ...
                fields: [
                    {
                        label: "Goal",
                        value: "Refactor the auth flow"
                    },
                    {
                        label: "Context",
                        value: "React app + shared UI kit"
                    }
                ]
            }
        ],
        ...
        configGroups: [
            ...
            },
            {
                ...
                fields: [
                    {
                        label: "Generated",
                        value: "Plan, substeps, risk notes"
                    }
                ]
            }
        ],
        ...
        configGroups: [
            {
                ...
                fields: [
                    {
                        label: "Planning + low risk",
                        value: "Direct executor"
                    },
                    {
                        label: "Cross-cutting + risky",
        ...
        configGroups: [
            ...
            },
            {
                ...
                fields: [
                    {
                        label: "Fields",
                        value: "stdout, diagnostics, artifacts"
                    }
                ]
            }
        ],
        ...
        configGroups: [
            {
                ...
                fields: [
                    {
                        label: "Tone",
                        value: "Concise operator"
                    },
                    {
                        label: "Output",
                        value: "Answer + execution trace"
                    }
                ]
            }
        ],
...
function getFixtureNodes(size) {
    return getFixture(size);
}
function getBackgroundWorkflowNode(selectedId) {
    return {
        id: selectedId,
        ...
        configGroups: [
            {
                ...
                fields: [
                    {
                        label: "Type",
                        value: "Background workflow step"
                    },
                    {
                        label: "Purpose",
                        value: "Adds realistic graph density around the main path"
                    }
                ]
            }
        ],
...
function renderGuidedSteps() {
    ...
    flowStatusEl.textContent = active ? `Next: ${active.title} — ${active.detail}` : "You completed the guided flow. Switch scenarios to compare the product story again.";
}
...
canvas.addEventListener("click", (event)=>{
    ...
    hitResultEl.textContent = hit === null ? `No hit at (${worldPoint.x.toFixed(1)}, ${worldPoint.y.toFixed(1)})` : `Hit node ${hit} at (${worldPoint.x.toFixed(1)}, ${worldPoint.y.toFixed(1)})`;
    if (hit !== null) {
        selectedNodeId = hit;
        renderWorkflowOutline();
        renderInspector();
